...
import { FacebookIcon , InstagramIcon  , LinkedinIcon } from "@animateicons/react/lucide";
...
export default function Footer() {
  ...
  const SOCIALS = [
    { name: "Facebook", href: "https://www.facebook.com/share/1Dw5Pmw1B6/", icon: FacebookIcon },
    { name: "Instagram", href: "https://www.instagram.com/tedxnewcairostemyouth/", icon: InstagramIcon },
    { name: "LinkedIn", href: "https://www.linkedin.com/company/tedxnewcairostemyouth/", icon: LinkedinIcon },
  ];
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 pb-16">
          ...
          {/* Brand Column */}
          <div className="footer-animate md:col-span-5 flex flex-col items-start opacity-0">
            ...
            <p className="text-[11px] sm:text-xs leading-relaxed max-w-sm text-white/35">
              TEDxNewCairoSTEMYouth is an independently organized TEDx event licensed by TED. 
              Our platform exists to showcase groundbreaking innovations, ignite potential, 
              and champion ideas worth spreading.
            </p>
          </div>

          {/* Navigation Column */}
          <div className="footer-animate md:col-span-3 flex flex-col opacity-0">
          ...
          {/* Connect Column */}
          <div className="footer-animate md:col-span-4 flex flex-col items-start opacity-0">
            <h3 className="text-white text-[10px] font-black tracking-[0.35em] uppercase mb-5">
              Connect
            </h3>
            <p className="text-[11px] sm:text-xs leading-relaxed mb-5 text-white/35">
              Stay updated with our latest announcements, speaker releases, and ticket drops.
            </p>
        ...
        {/* Bottom Bar */}
        <div className="footer-animate border-t border-white/5 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-[10px] sm:text-[11px] font-medium text-white/25 opacity-0">
          ...
          <div className="text-center sm:text-left leading-relaxed max-w-xl">
            <p className="text-white/35 font-semibold mb-1">
              © 2026 TEDxNewCairoSTEMYouth. All rights reserved.
            </p>
            <p className="text-[9.5px]">
              This independently organized TEDx event is operated under license from TED. 
              TED, the TED logo, and TEDx are registered trademarks of TED Conferences, LLC.
            </p>
          </div>
