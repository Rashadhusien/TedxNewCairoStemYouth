    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <SponsorsSectionHeader
          ...
          description="Visionary organizations already investing in Egypt's next generation of STEM leaders and changemakers."
        />
        ...
        <p className="mx-auto mt-10 max-w-2xl text-center text-sm text-muted-foreground">
          Additional partnership slots across Visionary, Platinum, Gold, Silver,
          and Bronze tiers are open for the 2026 edition.
        </p>
      </div>
    </section>
  );
