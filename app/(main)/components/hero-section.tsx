  ...
  return (
    <div ref={containerRef} className="relative h-screen overflow-hidden">
      <video
        ...
        muted
        playsInline
        className="w-full absolute -z-10 inset-0 min-h-screen aspect-auto object-cover origin-center will-change-[opacity,transform]"
      >
      ...
      <div className="container mx-auto flex justify-center h-full">
        <div className="flex flex-col gap-4 mt-[140px] sm:mt-[160px] items-center">
          ...
          <h1
            ref={headingRef}
            className="opacity-0 text-3xl sm:text-6xl font-extrabold text-center leading-tight"
          >
            Without darkness <br />
          ...
          <p
            ref={paragraphRef}
            className="opacity-0 text-sm md:text-base max-w-2xl mx-auto leading-relaxed mb-6 text-center text-white/70"
          >
          ...
          <div
            ref={buttonsRef}
            className="opacity-0 grid grid-cols-2 gap-4 w-full max-w-md max-sm:px-4"
          >
